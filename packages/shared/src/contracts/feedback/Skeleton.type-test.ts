...
export type SkeletonTypeContract = [
  ...
  Assert<IsExact<{ variant: 'grid'; label: 'Loading calendar'; cols: 7; cell: 40; gap: 8 }, SkeletonProps>>,
  ...
  Assert<IsExact<{ variant: 'grid'; label: 'Loading'; cell: 40; gap: 8 }, SkeletonProps>>,
  // @ts-expect-error grid requires cell
  Assert<IsExact<{ variant: 'grid'; label: 'Loading'; cols: 7; gap: 8 }, SkeletonProps>>,
  // @ts-expect-error grid requires gap
  Assert<IsExact<{ variant: 'grid'; label: 'Loading'; cols: 7; cell: 40 }, SkeletonProps>>,
  ...
  Assert<IsExact<{ variant: 'grid'; label: 'Loading'; cols: 7; cell: 40; gap: 10 }, SkeletonProps>>,
]
