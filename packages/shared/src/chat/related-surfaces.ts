 ...
 * (`ChatResponse.relatedSurfaces`) to their i18n label key and per-platform client route.
 * Both web and mobile consume this map; only the route field they read differs (platform
 * adapter).
 */
