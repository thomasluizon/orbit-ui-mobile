...
export const schemes: Record<ColorScheme, ColorSchemeDefinition> = {
  purple: {
    ...
    light: {
      ...
      textPrimary: '#1a1625', textSecondary: '#6b6580', textMuted: '#8a8498',
  ...
  blue: {
    ...
    light: {
      ...
      border: 'rgba(0, 0, 0, 0.08)', borderMuted: 'rgba(0, 0, 0, 0.04)',
      borderEmphasis: 'rgba(0, 0, 0, 0.12)',
      textPrimary: '#151a25', textSecondary: '#5c6b82', textMuted: '#7d8a9e',
  ...
  green: {
    ...
    light: {
      ...
      border: 'rgba(0, 0, 0, 0.08)', borderMuted: 'rgba(0, 0, 0, 0.04)',
      borderEmphasis: 'rgba(0, 0, 0, 0.12)',
      textPrimary: '#152018', textSecondary: '#5c7d6a', textMuted: '#7d9a8a',
  ...
  rose: {
    ...
    light: {
      ...
      border: 'rgba(0, 0, 0, 0.08)', borderMuted: 'rgba(0, 0, 0, 0.04)',
      borderEmphasis: 'rgba(0, 0, 0, 0.12)',
      textPrimary: '#201518', textSecondary: '#7d5c66', textMuted: '#9a7d86',
  ...
  orange: {
    ...
    light: {
      ...
      border: 'rgba(0, 0, 0, 0.08)', borderMuted: 'rgba(0, 0, 0, 0.04)',
      borderEmphasis: 'rgba(0, 0, 0, 0.12)',
      textPrimary: '#201810', textSecondary: '#7d6b58', textMuted: '#9a8878',
  ...
  cyan: {
    ...
    light: {
      ...
      border: 'rgba(0, 0, 0, 0.08)', borderMuted: 'rgba(0, 0, 0, 0.04)',
      borderEmphasis: 'rgba(0, 0, 0, 0.12)',
      textPrimary: '#151e20', textSecondary: '#5c7d85', textMuted: '#7d9aa2',
