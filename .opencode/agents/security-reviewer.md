...
Read `.claude/agents/security-reviewer.md` and follow it verbatim — that file is the single source of truth for this agent's behavior, inputs, and output format.
