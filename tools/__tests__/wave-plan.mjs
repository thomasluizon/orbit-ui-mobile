...
export const cases = () => {
    ...
    check("wave-plan.mjs", "the same relative path in different repositories is not a collision", ["--issues", "ORB-201,ORB-202"], { status: 0, stdout: /collisions: none/ }, { env: stubDescriptions(body("`CLAUDE.md`"), body("`CLAUDE.md`"), [{ name: "repo:ui" }], [{ name: "repo:api" }]) })
