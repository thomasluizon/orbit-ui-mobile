...
const subprocessOptionCases = async () => {
  const restricted = minimalChildEnvironment("reviewer", {
    ...
    ORBIT_REVIEW_AUTHORITY_PUBLIC_KEY: "review-public-sentinel",
  ...
  T(
    ...
    restricted.GH_TOKEN === undefined && restricted.GITHUB_TOKEN === undefined && restricted.LINEAR_API_KEY === undefined && restricted.ORBIT_REVIEW_AUTHORITY_PRIVATE_KEY === undefined && restricted.ORBIT_REVIEW_AUTHORITY_PUBLIC_KEY === undefined,
