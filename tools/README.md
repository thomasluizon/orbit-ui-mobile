...
| `redesign-coverage.mjs` | Asserts every surface in `surfaces.json` is claimed by exactly one #539 redesign ticket; exits 1 on any unclaimed surface (D35). Survives until #539 completes (D39). | `npm run redesign:coverage` (`--json`) |
