...
machinery proven against live Linear). **Phase 3 (the deletion) deliberately waits for the open
PRs to merge** - it deletes around files they touch. **Ten PRs await Thomas's review**:
ui #577 #578 #579 #580, api #427 #428 #429 #430, landing #46 #47 (merge #47 before #46).
...
| **3** | The deletion (section 5). Rewrite `CLAUDE.md` and `.claude/rules/core.md`. | ~34,000 lines lighter, all CI green |
