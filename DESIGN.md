...
| Off-grid icon size (Icons) | **new rule**: size outside 16 / 20 / 24 | blocked on [orbit-tickets#368](https://github.com/thomasluizon/orbit-tickets/issues/368): needs type information, not AST heuristics |
| Pill radius on a static element (Shape) | **new rule**: radius 999 outside `PillButton` and the interactive kit | blocked on [orbit-tickets#368](https://github.com/thomasluizon/orbit-tickets/issues/368): a style key cannot prove its consumer is static |
