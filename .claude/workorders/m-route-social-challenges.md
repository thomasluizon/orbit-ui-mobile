---
surfaceId: m-route-social-challenges
platform: mobile
kind: route
...
# Work order: m-route-social-challenges

## Goal

Bring `m-route-social-challenges` (`/social/challenges`) to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/mobile/app/social/challenges.tsx`
- `apps/mobile/app/social/challenges/_components/challenge-card.tsx`
- `apps/mobile/app/social/challenges/_components/challenge-list.tsx`
- `apps/mobile/app/social/challenges/_components/create-challenge-form.tsx`
- `apps/mobile/app/social/challenges/_components/invite-friends-picker.tsx`
- `apps/mobile/app/social/challenges/_components/join-by-code-form.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/app/social/challenges/_components/challenge-card.tsx` | `local/spacing-scale` | 6 |
| `apps/mobile/app/social/challenges/_components/create-challenge-form.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/challenges/_components/invite-friends-picker.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/challenges/_components/challenge-list.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/app/social/challenges/_components/join-by-code-form.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'm-route-social-challenges'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'm-route-social-challenges'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'm-route-social-challenges'`, and it is a veto
