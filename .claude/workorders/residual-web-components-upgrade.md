...
39 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/web/components/upgrade/billing-dashboard.tsx` | `local/spacing-scale` | 24 |
| `apps/web/components/upgrade/pricing-section.tsx` | `local/spacing-scale` | 9 |
| `apps/web/components/upgrade/play-billing-dashboard.tsx` | `local/spacing-scale` | 4 |
