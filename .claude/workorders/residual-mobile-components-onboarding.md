---
surfaceId: residual-mobile-components-onboarding
platform: mobile
kind: residual
ownedFiles: 3
cells: 0
...
# Work order: residual-mobile-components-onboarding
...
- `apps/mobile/components/onboarding/astra-import-prompt.tsx`
- `apps/mobile/components/onboarding/calendar-import-prompt.tsx`
- `apps/mobile/components/onboarding/feature-guide-drawer.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/onboarding/astra-import-prompt.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/onboarding/calendar-import-prompt.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/onboarding/feature-guide-drawer.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-onboarding'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-onboarding'` agrees.
