---
surfaceId: residual-mobile-app-social-_components
platform: mobile
kind: residual
ownedFiles: 4
cells: 0
...
# Work order: residual-mobile-app-social-_components
...
- `apps/mobile/app/social/_components/cheer-composer.tsx`
- `apps/mobile/app/social/_components/friend-profile-sheet.tsx`
- `apps/mobile/app/social/_components/habit-multi-select.tsx`
- `apps/mobile/app/social/_components/social-opt-in-gate.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/app/social/_components/friend-profile-sheet.tsx` | `local/spacing-scale` | 10 |
| `apps/mobile/app/social/_components/habit-multi-select.tsx` | `local/spacing-scale` | 10 |
| `apps/mobile/app/social/_components/cheer-composer.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/social-opt-in-gate.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-app-social-_components'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-app-social-_components'` agrees.
