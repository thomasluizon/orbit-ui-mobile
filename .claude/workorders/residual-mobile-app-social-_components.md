...
22 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
...
| `apps/mobile/app/social/_components/habit-multi-select.tsx` | `local/spacing-scale` | 8 |
