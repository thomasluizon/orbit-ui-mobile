---
surfaceId: overlay-habit-form-fields-habit-emoji-selector
platform: web
kind: overlay
ownedFiles: 1
cells: 4
...
# Work order: overlay-habit-form-fields-habit-emoji-selector

## Goal

Bring `overlay-habit-form-fields-habit-emoji-selector` to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/web/components/habits/habit-form-fields/habit-emoji-selector.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/habits/habit-form-fields/habit-emoji-selector.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'overlay-habit-form-fields-habit-emoji-selector'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'overlay-habit-form-fields-habit-emoji-selector'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'overlay-habit-form-fields-habit-emoji-selector'`, and it is a veto
