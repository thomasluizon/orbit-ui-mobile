...
- `apps/mobile/app/social/_components/social-section-skeleton.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

25 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
...
| `apps/mobile/app/social/_components/buddy-row.tsx` | `local/spacing-scale` | 4 |
...
| `apps/mobile/app/social/_components/buddy-invite-row.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/social-identity-bar.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/challenges-entry-card.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/app/social/_components/edit-handle-sheet.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/app/social/_components/friend-request-row.tsx` | `local/spacing-scale` | 1 |
