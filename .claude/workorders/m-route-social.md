...
# Work order: m-route-social

## Goal

Bring `m-route-social` (`/social`) to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/mobile/app/social.tsx`
- `apps/mobile/app/social/_components/accountability-section.tsx`
- `apps/mobile/app/social/_components/add-friend-form.tsx`
- `apps/mobile/app/social/_components/buddy-invite-row.tsx`
- `apps/mobile/app/social/_components/buddy-row.tsx`
- `apps/mobile/app/social/_components/challenges-entry-card.tsx`
- `apps/mobile/app/social/_components/edit-handle-sheet.tsx`
- `apps/mobile/app/social/_components/feed-event-card.tsx`
- `apps/mobile/app/social/_components/friend-request-row.tsx`
- `apps/mobile/app/social/_components/invite-confirm-sheet.tsx`
- `apps/mobile/app/social/_components/invite-hero.tsx`
- `apps/mobile/app/social/_components/new-pair-flow.tsx`
- `apps/mobile/app/social/_components/social-feed.tsx`
- `apps/mobile/app/social/_components/social-friends.tsx`
- `apps/mobile/app/social/_components/social-identity-bar.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

31 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/app/social/_components/buddy-row.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/app/social/_components/new-pair-flow.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/app/social/_components/invite-hero.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/app/social/_components/add-friend-form.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/app/social/_components/buddy-invite-row.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/app/social/_components/challenges-entry-card.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/feed-event-card.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/friend-request-row.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/social-identity-bar.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/_components/edit-handle-sheet.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/app/social/_components/invite-confirm-sheet.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/app/social/_components/social-feed.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'm-route-social'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'm-route-social'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'm-route-social'`, and it is a veto
