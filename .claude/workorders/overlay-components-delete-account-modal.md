...
4 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/profile/_components/delete-account-modal.tsx` | `local/spacing-scale` | 4 |
