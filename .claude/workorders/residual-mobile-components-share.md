---
surfaceId: residual-mobile-components-share
platform: mobile
kind: residual
ownedFiles: 3
cells: 0
...
- `apps/mobile/components/share/share-card-entry-button.tsx`
- `apps/mobile/components/share/share-card-sheet.tsx`
- `apps/mobile/components/share/share-card.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/share/share-card.tsx` | `local/spacing-scale` | 17 |
| `apps/mobile/components/share/share-card-sheet.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/share/share-card-entry-button.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-share'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-share'` agrees.
