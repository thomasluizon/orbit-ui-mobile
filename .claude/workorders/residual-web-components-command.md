---
surfaceId: residual-web-components-command
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-components-command
...
- `apps/web/components/command/command-menu.tsx`
- `apps/web/components/command/command-row.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/command/command-menu.tsx` | `local/spacing-scale` | 7 |
| `apps/web/components/command/command-row.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-command'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-command'` agrees.
