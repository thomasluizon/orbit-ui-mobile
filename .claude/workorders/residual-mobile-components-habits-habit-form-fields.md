---
surfaceId: residual-mobile-components-habits-habit-form-fields
platform: mobile
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-mobile-components-habits-habit-form-fields
...
- `apps/mobile/components/habits/habit-form-fields/styles.ts`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/habits/habit-form-fields/styles.ts` | `local/spacing-scale` | 30 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-habits-habit-form-fields'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-habits-habit-form-fields'` agrees.
