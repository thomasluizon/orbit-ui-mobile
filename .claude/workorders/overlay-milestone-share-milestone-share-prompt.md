---
surfaceId: overlay-milestone-share-milestone-share-prompt
platform: web
kind: overlay
ownedFiles: 1
cells: 4
...
# Work order: overlay-milestone-share-milestone-share-prompt

## Goal

Bring `overlay-milestone-share-milestone-share-prompt` to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/web/components/milestone-share/milestone-share-prompt.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/milestone-share/milestone-share-prompt.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'overlay-milestone-share-milestone-share-prompt'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'overlay-milestone-share-milestone-share-prompt'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'overlay-milestone-share-milestone-share-prompt'`, and it is a veto
