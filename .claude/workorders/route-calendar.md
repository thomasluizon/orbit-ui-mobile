...
| file | rule | count |
|---|---|---|
| `apps/web/components/calendar/calendar-time-grid.tsx` | `local/spacing-scale` | 10 |
...
| `apps/web/components/calendar/calendar-day-detail.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/calendar/page.tsx` | `local/spacing-scale` | 1 |
