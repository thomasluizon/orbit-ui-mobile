---
surfaceId: residual-web-components-habits-habit-form-fields
platform: web
kind: residual
ownedFiles: 7
cells: 0
...
# Work order: residual-web-components-habits-habit-form-fields
...
- `apps/web/components/habits/habit-form-fields/color-swatches.tsx`
- `apps/web/components/habits/habit-form-fields/frequency-type-cards.tsx`
- `apps/web/components/habits/habit-form-fields/habit-tag-chip.tsx`
- `apps/web/components/habits/habit-form-fields/reminder-section.tsx`
- `apps/web/components/habits/habit-form-fields/scheduled-reminder-section.tsx`
- `apps/web/components/habits/habit-form-fields/slip-alert-section.tsx`
- `apps/web/components/habits/habit-form-fields/tag-editor-row.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/habits/habit-form-fields/reminder-section.tsx` | `local/spacing-scale` | 10 |
| `apps/web/components/habits/habit-form-fields/scheduled-reminder-section.tsx` | `local/spacing-scale` | 7 |
| `apps/web/components/habits/habit-form-fields/frequency-type-cards.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-form-fields/slip-alert-section.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-form-fields/tag-editor-row.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-form-fields/habit-tag-chip.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/habits/habit-form-fields/color-swatches.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-habits-habit-form-fields'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-habits-habit-form-fields'` agrees.
