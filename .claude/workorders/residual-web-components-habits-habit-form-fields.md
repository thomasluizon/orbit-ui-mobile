...
35 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
...
| `apps/web/components/habits/habit-form-fields/frequency-type-cards.tsx` | `local/spacing-scale` | 5 |
| `apps/web/components/habits/habit-form-fields/slip-alert-section.tsx` | `local/spacing-scale` | 5 |
