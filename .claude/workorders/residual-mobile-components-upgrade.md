---
surfaceId: residual-mobile-components-upgrade
platform: mobile
kind: residual
ownedFiles: 4
cells: 0
...
# Work order: residual-mobile-components-upgrade
...
- `apps/mobile/components/upgrade/plan-card.tsx`
- `apps/mobile/components/upgrade/pricing-section.tsx`
- `apps/mobile/components/upgrade/styles.ts`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/upgrade/styles.ts` | `local/spacing-scale` | 17 |
| `apps/mobile/components/upgrade/plan-card.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/upgrade/pricing-section.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/upgrade/billing-dashboard.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-upgrade'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-upgrade'` agrees.
