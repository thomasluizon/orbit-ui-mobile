---
surfaceId: residual-web-components-goals
platform: web
kind: residual
ownedFiles: 3
cells: 0
...
# Work order: residual-web-components-goals
...
- `apps/web/components/goals/goal-detail-sections.tsx`
- `apps/web/components/goals/goal-metrics-panel.tsx`
- `apps/web/components/goals/goal-status-badge.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/goals/goal-detail-sections.tsx` | `local/spacing-scale` | 7 |
| `apps/web/components/goals/goal-metrics-panel.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/goals/goal-status-badge.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-goals'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-goals'` agrees.
