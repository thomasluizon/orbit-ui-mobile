...
| `apps/web/app/(app)/social/_components/challenges-entry-card.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/social/_components/feed-event-card.tsx` | `local/spacing-scale` | 2 |
