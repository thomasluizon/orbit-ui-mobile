---
surfaceId: residual-mobile-components-milestone-share
platform: mobile
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-mobile-components-milestone-share
...
- `apps/mobile/components/milestone-share/milestone-share-card.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/milestone-share/milestone-share-card.tsx` | `local/spacing-scale` | 11 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-milestone-share'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-milestone-share'` agrees.
