---
surfaceId: m-route-calendar-sync-select-all-toggle
platform: mobile
kind: route
href: /calendar-sync-select-all-toggle
ownedFiles: 1
cells: 4
mechanicalDebt: 0
pixelEvidence: none
...
# Work order: m-route-calendar-sync-select-all-toggle

## Goal

Bring `m-route-calendar-sync-select-all-toggle` (`/calendar-sync-select-all-toggle`) to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/mobile/app/calendar-sync-select-all-toggle.tsx`
