...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/navigation/notification-bell.styles.ts` | `local/spacing-scale` | 3 |
| `apps/mobile/components/navigation/notification-detail-modal.tsx` | `local/spacing-scale` | 2 |
