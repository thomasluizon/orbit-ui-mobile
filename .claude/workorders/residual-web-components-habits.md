...
| `apps/web/components/habits/habit-checklist.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-list.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-row-leading.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/today-ai-summary.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-row-content.tsx` | `local/spacing-scale` | 3 |
...
| `apps/web/components/habits/habit-row-menu.tsx` | `local/spacing-scale` | 1 |
