---
surfaceId: residual-web-components-habits
platform: web
kind: residual
ownedFiles: 11
cells: 0
...
# Work order: residual-web-components-habits
...
- `apps/web/components/habits/checklist-templates.tsx`
- `apps/web/components/habits/habit-calendar.tsx`
- `apps/web/components/habits/habit-checklist.tsx`
- `apps/web/components/habits/habit-detail-sections.tsx`
- `apps/web/components/habits/habit-form-fields.tsx`
- `apps/web/components/habits/habit-list.tsx`
- `apps/web/components/habits/habit-row-check-circle.tsx`
- `apps/web/components/habits/habit-row-content.tsx`
- `apps/web/components/habits/habit-row-leading.tsx`
- `apps/web/components/habits/habit-row-menu.tsx`
...
37 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/web/components/habits/checklist-templates.tsx` | `local/spacing-scale` | 7 |
| `apps/web/components/habits/habit-checklist.tsx` | `local/spacing-scale` | 6 |
| `apps/web/components/habits/today-ai-summary.tsx` | `local/spacing-scale` | 6 |
| `apps/web/components/habits/habit-list.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-row-content.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-calendar.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/habits/habit-row-check-circle.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/habits/habit-row-leading.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/habits/habit-row-menu.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/habits/habit-detail-sections.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/habits/habit-form-fields.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-habits'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-habits'` agrees.
