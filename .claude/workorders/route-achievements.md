...
# Work order: route-achievements

## Goal

Bring `route-achievements` (`/achievements`) to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/web/app/(app)/achievements/_components/achievement-category-section.tsx`
- `apps/web/app/(app)/achievements/_components/achievement-xp-card.tsx`
- `apps/web/app/(app)/achievements/_components/achievements-locked-state.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/achievements/_components/achievement-xp-card.tsx` | `local/spacing-scale` | 4 |
| `apps/web/app/(app)/achievements/_components/achievement-category-section.tsx` | `local/spacing-scale` | 3 |
| `apps/web/app/(app)/achievements/_components/achievements-locked-state.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'route-achievements'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'route-achievements'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'route-achievements'`, and it is a veto
