---
surfaceId: residual-mobile-app-social-challenges-_components
platform: mobile
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-mobile-app-social-challenges-_components
...
- `apps/mobile/app/social/challenges/_components/habit-picker.tsx`
- `apps/mobile/app/social/challenges/_components/share-join-code.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/app/social/challenges/_components/share-join-code.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/social/challenges/_components/habit-picker.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-app-social-challenges-_components'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-app-social-challenges-_components'` agrees.
