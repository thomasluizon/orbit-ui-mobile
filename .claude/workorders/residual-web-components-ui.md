---
surfaceId: residual-web-components-ui
platform: web
kind: residual
ownedFiles: 15
cells: 0
...
# Work order: residual-web-components-ui
...
- `apps/web/components/ui/app-bar.tsx`
- `apps/web/components/ui/badge.tsx`
- `apps/web/components/ui/code-input.tsx`
- `apps/web/components/ui/empty-state.tsx`
- `apps/web/components/ui/field-input.tsx`
- `apps/web/components/ui/highlight-text.tsx`
- `apps/web/components/ui/info-card.tsx`
- `apps/web/components/ui/offline-unavailable-state.tsx`
- `apps/web/components/ui/quiet-link.tsx`
- `apps/web/components/ui/settings-group.tsx`
- `apps/web/components/ui/settings-row.tsx`
- `apps/web/components/ui/stat-tile.tsx`
- `apps/web/components/ui/trial-banner.tsx`
- `apps/web/components/ui/update-prompt.tsx`
- `apps/web/components/ui/year-picker.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

36 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/web/components/ui/app-bar.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/ui/settings-row.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/ui/trial-banner.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/ui/empty-state.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/ui/info-card.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/ui/offline-unavailable-state.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/ui/settings-group.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/ui/update-prompt.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/ui/badge.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/ui/year-picker.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/ui/code-input.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/ui/field-input.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/ui/highlight-text.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/ui/quiet-link.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/ui/stat-tile.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-ui'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-ui'` agrees.
