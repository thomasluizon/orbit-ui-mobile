---
surfaceId: residual-web-app-(app)-profile-_components
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-app-(app)-profile-_components
...
- `apps/web/app/(app)/profile/_components/next-reward-carrot.tsx`
- `apps/web/app/(app)/profile/_components/profile-action-button.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/profile/_components/next-reward-carrot.tsx` | `local/spacing-scale` | 3 |
| `apps/web/app/(app)/profile/_components/profile-action-button.tsx` | `local/spacing-scale` | 1 |
...
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-app-(app)-profile-_components'` agrees.
