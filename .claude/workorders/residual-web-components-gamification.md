---
surfaceId: residual-web-components-gamification
platform: web
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-web-components-gamification
...
- `apps/web/components/gamification/streak-badge.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/gamification/streak-badge.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-gamification'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-gamification'` agrees.
