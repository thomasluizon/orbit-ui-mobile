---
surfaceId: residual-web-components-onboarding
platform: web
kind: residual
ownedFiles: 8
cells: 0
...
# Work order: residual-web-components-onboarding
...
- `apps/web/components/onboarding/onboarding-complete-habit.tsx`
- `apps/web/components/onboarding/onboarding-complete.tsx`
- `apps/web/components/onboarding/onboarding-create-goal.tsx`
- `apps/web/components/onboarding/onboarding-create-habit.tsx`
- `apps/web/components/onboarding/onboarding-features.tsx`
- `apps/web/components/onboarding/onboarding-meet-astra.tsx`
- `apps/web/components/onboarding/onboarding-template-packs.tsx`
- `apps/web/components/onboarding/onboarding-welcome.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

27 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/web/components/onboarding/onboarding-features.tsx` | `local/spacing-scale` | 5 |
| `apps/web/components/onboarding/onboarding-template-packs.tsx` | `local/spacing-scale` | 5 |
| `apps/web/components/onboarding/onboarding-complete-habit.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/onboarding/onboarding-complete.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/onboarding/onboarding-meet-astra.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/onboarding/onboarding-create-goal.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/onboarding/onboarding-create-habit.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/onboarding/onboarding-welcome.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-onboarding'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-onboarding'` agrees.
