---
surfaceId: residual-web-components-habits-habit-list
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-components-habits-habit-list
...
- `apps/web/components/habits/habit-list/drill-content.tsx`
- `apps/web/components/habits/habit-list/empty-state.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/habits/habit-list/empty-state.tsx` | `local/spacing-scale` | 4 |
| `apps/web/components/habits/habit-list/drill-content.tsx` | `local/spacing-scale` | 2 |
...
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-habits-habit-list'` agrees.
