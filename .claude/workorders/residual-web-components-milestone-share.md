---
surfaceId: residual-web-components-milestone-share
platform: web
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-web-components-milestone-share
...
- `apps/web/components/milestone-share/milestone-share-card.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/milestone-share/milestone-share-card.tsx` | `local/spacing-scale` | 10 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-milestone-share'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-milestone-share'` agrees.
