...
17 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
...
| `apps/web/components/chat/pending-operation-card.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/chat/breakdown-habit-row.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/chat/breakdown-suggestion.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/chat/message-bubble.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/chat/typing-indicator.tsx` | `local/spacing-scale` | 1 |
