---
surfaceId: residual-web-components-chat
platform: web
kind: residual
ownedFiles: 8
cells: 0
...
# Work order: residual-web-components-chat
...
- `apps/web/components/chat/breakdown-habit-row.tsx`
- `apps/web/components/chat/breakdown-suggestion.tsx`
- `apps/web/components/chat/conflict-warning.tsx`
- `apps/web/components/chat/goal-list-card.tsx`
- `apps/web/components/chat/habit-list-card.tsx`
- `apps/web/components/chat/message-bubble.tsx`
- `apps/web/components/chat/pending-operation-card.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/chat/habit-list-card.tsx` | `local/spacing-scale` | 6 |
| `apps/web/components/chat/goal-list-card.tsx` | `local/spacing-scale` | 5 |
| `apps/web/components/chat/message-bubble.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/chat/pending-operation-card.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/chat/typing-indicator.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/chat/breakdown-habit-row.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/chat/conflict-warning.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/chat/breakdown-suggestion.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-chat'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-chat'` agrees.
