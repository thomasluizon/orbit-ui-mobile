...
68 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/app/retrospective-styles.ts` | `local/spacing-scale` | 12 |
| `apps/mobile/app/streak-sections-styles.ts` | `local/spacing-scale` | 12 |
| `apps/mobile/app/advanced-styles.ts` | `local/spacing-scale` | 10 |
| `apps/mobile/app/calendar-sync-styles.ts` | `local/spacing-scale` | 10 |
| `apps/mobile/app/ai-settings-styles.ts` | `local/spacing-scale` | 8 |
| `apps/mobile/app/wrapped-styles.ts` | `local/spacing-scale` | 8 |
| `apps/mobile/app/chat.styles.ts` | `local/spacing-scale` | 5 |
| `apps/mobile/app/preferences-styles.ts` | `local/spacing-scale` | 2 |
| `apps/mobile/app/login-styles.ts` | `local/spacing-scale` | 1 |
