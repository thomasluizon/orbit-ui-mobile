...
# Work order: residual-mobile-app
...
- `apps/mobile/app/advanced-styles.ts`
- `apps/mobile/app/ai-settings-styles.ts`
- `apps/mobile/app/calendar-sync-styles.ts`
- `apps/mobile/app/chat.styles.ts`
- `apps/mobile/app/login-styles.ts`
- `apps/mobile/app/preferences-styles.ts`
- `apps/mobile/app/retrospective-styles.ts`
- `apps/mobile/app/streak-sections-styles.ts`
- `apps/mobile/app/wrapped-styles.ts`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

100 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/app/streak-sections-styles.ts` | `local/spacing-scale` | 17 |
| `apps/mobile/app/retrospective-styles.ts` | `local/spacing-scale` | 16 |
| `apps/mobile/app/calendar-sync-styles.ts` | `local/spacing-scale` | 15 |
| `apps/mobile/app/advanced-styles.ts` | `local/spacing-scale` | 12 |
| `apps/mobile/app/ai-settings-styles.ts` | `local/spacing-scale` | 12 |
| `apps/mobile/app/chat.styles.ts` | `local/spacing-scale` | 10 |
| `apps/mobile/app/wrapped-styles.ts` | `local/spacing-scale` | 8 |
| `apps/mobile/app/login-styles.ts` | `local/spacing-scale` | 5 |
| `apps/mobile/app/preferences-styles.ts` | `local/spacing-scale` | 3 |
| `apps/mobile/app/+not-found.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-app'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-app'` agrees.
