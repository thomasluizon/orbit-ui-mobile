---
surfaceId: residual-mobile-components-habits
platform: mobile
kind: residual
ownedFiles: 7
cells: 0
...
# Work order: residual-mobile-components-habits
...
- `apps/mobile/components/habits/bulk-action-bar-v2.tsx`
- `apps/mobile/components/habits/checklist-templates.tsx`
- `apps/mobile/components/habits/goal-linking-field.tsx`
- `apps/mobile/components/habits/habit-checklist.tsx`
- `apps/mobile/components/habits/habit-row-styles.ts`
- `apps/mobile/components/habits/reschedule-sheet.tsx`
- `apps/mobile/components/habits/today-ai-summary.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

44 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/components/habits/reschedule-sheet.tsx` | `local/spacing-scale` | 13 |
| `apps/mobile/components/habits/checklist-templates.tsx` | `local/spacing-scale` | 11 |
| `apps/mobile/components/habits/habit-row-styles.ts` | `local/spacing-scale` | 8 |
| `apps/mobile/components/habits/today-ai-summary.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/habits/habit-checklist.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/habits/bulk-action-bar-v2.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/habits/goal-linking-field.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-habits'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-habits'` agrees.
