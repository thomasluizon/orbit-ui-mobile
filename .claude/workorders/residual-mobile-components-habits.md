...
32 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/components/habits/reschedule-sheet.tsx` | `local/spacing-scale` | 12 |
| `apps/mobile/components/habits/checklist-templates.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/habits/today-ai-summary.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/habits/habit-row-styles.ts` | `local/spacing-scale` | 4 |
| `apps/mobile/components/habits/habit-checklist.tsx` | `local/spacing-scale` | 3 |
