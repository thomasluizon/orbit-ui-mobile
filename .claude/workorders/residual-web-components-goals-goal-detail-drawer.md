---
surfaceId: residual-web-components-goals-goal-detail-drawer
platform: web
kind: residual
ownedFiles: 3
cells: 0
...
# Work order: residual-web-components-goals-goal-detail-drawer
...
- `apps/web/components/goals/goal-detail-drawer/goal-load-error.tsx`
- `apps/web/components/goals/goal-detail-drawer/goal-progress-block.tsx`
- `apps/web/components/goals/goal-detail-drawer/goal-progress-ring.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/goals/goal-detail-drawer/goal-progress-block.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/goals/goal-detail-drawer/goal-load-error.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/goals/goal-detail-drawer/goal-progress-ring.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-goals-goal-detail-drawer'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-goals-goal-detail-drawer'` agrees.
