---
surfaceId: residual-mobile-components-goals-edit-goal-modal
platform: mobile
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-mobile-components-goals-edit-goal-modal
...
- `apps/mobile/components/goals/edit-goal-modal/styles.ts`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/goals/edit-goal-modal/styles.ts` | `local/spacing-scale` | 3 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-goals-edit-goal-modal'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-goals-edit-goal-modal'` agrees.
