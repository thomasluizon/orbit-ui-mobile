...
24 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
...
| `apps/mobile/components/ui/settings-group.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/trial-banner.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/app-toast.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/section-head-tabs.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/highlight-text.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/components/ui/offline-unavailable-state.tsx` | `local/spacing-scale` | 1 |
