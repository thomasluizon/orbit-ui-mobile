---
surfaceId: residual-mobile-components-ui
platform: mobile
kind: residual
ownedFiles: 22
cells: 0
...
# Work order: residual-mobile-components-ui
...
- `apps/mobile/components/ui/app-bar.tsx`
- `apps/mobile/components/ui/app-error-boundary.tsx`
- `apps/mobile/components/ui/app-text-input.tsx`
- `apps/mobile/components/ui/app-toast.tsx`
- `apps/mobile/components/ui/badge.tsx`
- `apps/mobile/components/ui/bottom-sheet-app-text-input.tsx`
- `apps/mobile/components/ui/chip.tsx`
- `apps/mobile/components/ui/code-input.tsx`
- `apps/mobile/components/ui/create-api-key-modal.styles.ts`
- `apps/mobile/components/ui/empty-state.tsx`
- `apps/mobile/components/ui/expiry-warning.tsx`
- `apps/mobile/components/ui/field-input.tsx`
- `apps/mobile/components/ui/highlight-text.tsx`
- `apps/mobile/components/ui/info-card.tsx`
- `apps/mobile/components/ui/offline-unavailable-state.tsx`
- `apps/mobile/components/ui/scroll-to-top-button.tsx`
- `apps/mobile/components/ui/section-head-tabs.tsx`
- `apps/mobile/components/ui/settings-group.tsx`
- `apps/mobile/components/ui/settings-row.tsx`
- `apps/mobile/components/ui/stat-tile.tsx`
- `apps/mobile/components/ui/trial-banner.tsx`
- `apps/mobile/components/ui/year-picker.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

69 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/components/ui/create-api-key-modal.styles.ts` | `local/spacing-scale` | 7 |
| `apps/mobile/components/ui/empty-state.tsx` | `local/spacing-scale` | 6 |
| `apps/mobile/components/ui/app-text-input.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/ui/expiry-warning.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/ui/offline-unavailable-state.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/ui/settings-group.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/ui/settings-row.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/ui/trial-banner.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/ui/app-bar.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/app-error-boundary.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/bottom-sheet-app-text-input.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/info-card.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/section-head-tabs.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/ui/app-toast.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/badge.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/chip.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/field-input.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/stat-tile.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/ui/app-toast.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/ui/code-input.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/components/ui/expiry-warning.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/ui/highlight-text.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/components/ui/scroll-to-top-button.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/ui/year-picker.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-ui'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-ui'` agrees.
