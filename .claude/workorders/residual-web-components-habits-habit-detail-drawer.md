---
surfaceId: residual-web-components-habits-habit-detail-drawer
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-components-habits-habit-detail-drawer
...
- `apps/web/components/habits/habit-detail-drawer/habit-ask-astra-button.tsx`
- `apps/web/components/habits/habit-detail-drawer/habit-detail-header.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/habits/habit-detail-drawer/habit-ask-astra-button.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/habits/habit-detail-drawer/habit-detail-header.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-habits-habit-detail-drawer'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-habits-habit-detail-drawer'` agrees.
