...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/calendar-sync/_components/auto-sync-settings-card.tsx` | `local/spacing-scale` | 8 |
| `apps/web/app/(app)/calendar-sync/_components/calendar-sync-event-row.tsx` | `local/spacing-scale` | 6 |
