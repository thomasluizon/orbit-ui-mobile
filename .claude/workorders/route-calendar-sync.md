...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/calendar-sync/_components/auto-sync-settings-card.tsx` | `local/spacing-scale` | 7 |
| `apps/web/app/(app)/calendar-sync/page.tsx` | `local/spacing-scale` | 4 |
| `apps/web/app/(app)/calendar-sync/_components/calendar-picker-section.tsx` | `local/spacing-scale` | 3 |
| `apps/web/app/(app)/calendar-sync/_components/calendar-sync-event-row.tsx` | `local/spacing-scale` | 3 |
