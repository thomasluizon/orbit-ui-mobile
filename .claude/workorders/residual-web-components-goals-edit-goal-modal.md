---
surfaceId: residual-web-components-goals-edit-goal-modal
platform: web
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-web-components-goals-edit-goal-modal
...
- `apps/web/components/goals/edit-goal-modal/edit-goal-deadline-field.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/goals/edit-goal-modal/edit-goal-deadline-field.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-goals-edit-goal-modal'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-goals-edit-goal-modal'` agrees.
