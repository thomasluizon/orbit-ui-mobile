...
8 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/app/(tabs)/profile/_components/profile-styles.ts` | `local/spacing-scale` | 3 |
| `apps/mobile/app/(tabs)/profile/_components/delete-account-modal.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/app/(tabs)/profile/_components/edit-name-sheet.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/app/(tabs)/profile/_components/fresh-start-modal.tsx` | `local/spacing-scale` | 1 |
