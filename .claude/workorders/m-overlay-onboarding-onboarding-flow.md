---
surfaceId: m-overlay-onboarding-onboarding-flow
platform: mobile
kind: overlay
ownedFiles: 11
cells: 4
...
# Work order: m-overlay-onboarding-onboarding-flow

## Goal

Bring `m-overlay-onboarding-onboarding-flow` to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/mobile/components/onboarding/onboarding-complete-habit.tsx`
- `apps/mobile/components/onboarding/onboarding-complete.tsx`
- `apps/mobile/components/onboarding/onboarding-create-goal.tsx`
- `apps/mobile/components/onboarding/onboarding-create-habit.tsx`
- `apps/mobile/components/onboarding/onboarding-features.tsx`
- `apps/mobile/components/onboarding/onboarding-flow.styles.ts`
- `apps/mobile/components/onboarding/onboarding-flow.tsx`
- `apps/mobile/components/onboarding/onboarding-meet-astra.tsx`
- `apps/mobile/components/onboarding/onboarding-template-packs.tsx`
- `apps/mobile/components/onboarding/onboarding-welcome.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

30 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/components/onboarding/onboarding-complete.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/onboarding/onboarding-features.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/onboarding/onboarding-template-packs.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/onboarding/onboarding-complete-habit.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/onboarding/onboarding-create-habit.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/onboarding/onboarding-meet-astra.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/onboarding/onboarding-welcome.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/onboarding/onboarding-create-goal.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/onboarding/onboarding-flow.styles.ts` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'm-overlay-onboarding-onboarding-flow'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'm-overlay-onboarding-onboarding-flow'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'm-overlay-onboarding-onboarding-flow'`, and it is a veto
