...
- `apps/web/components/shell/rail-astra-pill.tsx`
- `apps/web/components/shell/rail-consistency.tsx`
- `apps/web/components/shell/rail-next-achievement.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/navigation/bottom-tab-bar.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/ui/update-available-banner.tsx` | `local/spacing-scale` | 3 |
| `apps/web/components/shell/desktop-topbar.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/ui/expiry-warning.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/ui/push-prompt.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/layout.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/shell/astra-copilot-rail.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/shell/rail-astra-pill.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/shell/rail-next-achievement.tsx` | `local/spacing-scale` | 1 |
