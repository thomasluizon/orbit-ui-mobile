...
| file | rule | count |
|---|---|---|
| `apps/web/components/navigation/bottom-tab-bar.tsx` | `local/spacing-scale` | 5 |
| `apps/web/components/shell/desktop-topbar.tsx` | `local/spacing-scale` | 4 |
...
| `apps/web/components/shell/progress-orbit.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/shell/today-rail.tsx` | `local/spacing-scale` | 1 |
| `apps/web/components/ui/expiry-warning.tsx` | `local/no-arbitrary-zindex` | 1 |
