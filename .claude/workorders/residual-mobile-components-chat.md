...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/chat/breakdown-suggestion.styles.ts` | `local/spacing-scale` | 8 |
| `apps/mobile/components/chat/goal-list-card.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/chat/habit-list-card.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/chat/pending-operation-card.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/chat/clarification-card.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/chat/typing-indicator.tsx` | `local/spacing-scale` | 1 |
