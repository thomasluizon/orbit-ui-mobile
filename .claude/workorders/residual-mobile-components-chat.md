---
surfaceId: residual-mobile-components-chat
platform: mobile
kind: residual
ownedFiles: 8
cells: 0
...
# Work order: residual-mobile-components-chat
...
- `apps/mobile/components/chat/action-chips.tsx`
- `apps/mobile/components/chat/breakdown-suggestion.styles.ts`
- `apps/mobile/components/chat/clarification-card.tsx`
- `apps/mobile/components/chat/conflict-warning.tsx`
- `apps/mobile/components/chat/goal-list-card.tsx`
- `apps/mobile/components/chat/habit-list-card.tsx`
- `apps/mobile/components/chat/pending-operation-card.tsx`
- `apps/mobile/components/chat/typing-indicator.tsx`

## Backlog A: enumerated and machine-COUNTED (the fix is still a judgement call)

40 suppressed DESIGN.md violation(s) in your owned files. These are real defects that
were measured and committed to the lint baseline, then never assigned to anyone.

| file | rule | count |
|---|---|---|
| `apps/mobile/components/chat/breakdown-suggestion.styles.ts` | `local/spacing-scale` | 11 |
| `apps/mobile/components/chat/pending-operation-card.tsx` | `local/spacing-scale` | 8 |
| `apps/mobile/components/chat/habit-list-card.tsx` | `local/spacing-scale` | 6 |
| `apps/mobile/components/chat/goal-list-card.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/components/chat/conflict-warning.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/chat/typing-indicator.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/components/chat/action-chips.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/chat/clarification-card.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-chat'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-chat'` agrees.
