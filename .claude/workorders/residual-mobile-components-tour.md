---
surfaceId: residual-mobile-components-tour
platform: mobile
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-mobile-components-tour
...
- `apps/mobile/components/tour/tour-replay-modal.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/tour/tour-replay-modal.tsx` | `local/spacing-scale` | 3 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-tour'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-tour'` agrees.
