---
surfaceId: route-social-challenges
platform: web
kind: route
...
# Work order: route-social-challenges

## Goal

Bring `route-social-challenges` (`/social/challenges`) to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/web/app/(app)/social/challenges/_components/challenge-action-buttons.tsx`
- `apps/web/app/(app)/social/challenges/_components/challenge-card.tsx`
- `apps/web/app/(app)/social/challenges/_components/challenge-list.tsx`
- `apps/web/app/(app)/social/challenges/_components/challenges-content.tsx`
- `apps/web/app/(app)/social/challenges/_components/challenges-topbar-heading.tsx`
- `apps/web/app/(app)/social/challenges/_components/create-challenge-form.tsx`
- `apps/web/app/(app)/social/challenges/_components/invite-friends-picker.tsx`
- `apps/web/app/(app)/social/challenges/_components/join-by-code-form.tsx`
- `apps/web/app/(app)/social/challenges/page.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/social/challenges/_components/challenge-card.tsx` | `local/spacing-scale` | 4 |
| `apps/web/app/(app)/social/challenges/_components/challenge-list.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/social/challenges/_components/invite-friends-picker.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/social/challenges/_components/create-challenge-form.tsx` | `local/spacing-scale` | 1 |
| `apps/web/app/(app)/social/challenges/_components/join-by-code-form.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'route-social-challenges'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'route-social-challenges'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'route-social-challenges'`, and it is a veto
