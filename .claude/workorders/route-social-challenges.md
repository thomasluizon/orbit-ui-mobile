...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/social/challenges/_components/challenge-card.tsx` | `local/spacing-scale` | 5 |
| `apps/web/app/(app)/social/challenges/_components/challenge-list.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/social/challenges/_components/challenges-content.tsx` | `local/spacing-scale` | 2 |
