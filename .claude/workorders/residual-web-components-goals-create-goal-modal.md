---
surfaceId: residual-web-components-goals-create-goal-modal
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-components-goals-create-goal-modal
...
- `apps/web/components/goals/create-goal-modal/goal-deadline-field.tsx`
- `apps/web/components/goals/create-goal-modal/goal-type-selector.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/goals/create-goal-modal/goal-type-selector.tsx` | `local/spacing-scale` | 2 |
| `apps/web/components/goals/create-goal-modal/goal-deadline-field.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-goals-create-goal-modal'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-goals-create-goal-modal'` agrees.
