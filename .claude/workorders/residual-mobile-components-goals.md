---
surfaceId: residual-mobile-components-goals
platform: mobile
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-mobile-components-goals
...
- `apps/mobile/components/goals/goal-list.tsx`
- `apps/mobile/components/goals/goals-view.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/goals/goal-list.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/components/goals/goals-view.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-mobile-components-goals'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-mobile-components-goals'` agrees.
