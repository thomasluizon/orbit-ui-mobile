...
| file | rule | count |
|---|---|---|
| `apps/mobile/app/(tabs)/calendar/_components/calendar-time-grid.tsx` | `local/spacing-scale` | 5 |
| `apps/mobile/app/(tabs)/calendar/_components/calendar-grid.tsx` | `local/spacing-scale` | 3 |
| `apps/mobile/app/(tabs)/calendar/_components/calendar-day-entry.tsx` | `local/spacing-scale` | 2 |
