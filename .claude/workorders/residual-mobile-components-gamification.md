...
- `apps/mobile/components/gamification/all-done-celebration.tsx`
- `apps/mobile/components/gamification/goal-completed-celebration.tsx`
- `apps/mobile/components/gamification/level-up-overlay.tsx`
- `apps/mobile/components/gamification/streak-badge.tsx`
- `apps/mobile/components/gamification/streak-celebration.tsx`
- `apps/mobile/components/gamification/streak-freeze-celebration.tsx`
...
| `apps/mobile/components/gamification/welcome-back-toast.tsx` | `local/spacing-scale` | 2 |
| `apps/mobile/components/gamification/achievement-toast.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/gamification/all-done-celebration.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/gamification/goal-completed-celebration.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/gamification/level-up-overlay.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/gamification/streak-badge.tsx` | `local/spacing-scale` | 1 |
| `apps/mobile/components/gamification/streak-celebration.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/gamification/streak-freeze-celebration.tsx` | `local/no-arbitrary-zindex` | 1 |
| `apps/mobile/components/gamification/welcome-back-toast.tsx` | `local/no-arbitrary-zindex` | 1 |
