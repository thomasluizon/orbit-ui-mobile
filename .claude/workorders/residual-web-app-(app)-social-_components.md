---
surfaceId: residual-web-app-(app)-social-_components
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-app-(app)-social-_components
...
- `apps/web/app/(app)/social/_components/habit-multi-select.tsx`
- `apps/web/app/(app)/social/_components/social-opt-in-gate.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/social/_components/habit-multi-select.tsx` | `local/spacing-scale` | 9 |
| `apps/web/app/(app)/social/_components/social-opt-in-gate.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-app-(app)-social-_components'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-app-(app)-social-_components'` agrees.
