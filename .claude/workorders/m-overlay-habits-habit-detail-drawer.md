---
surfaceId: m-overlay-habits-habit-detail-drawer
platform: mobile
kind: overlay
ownedFiles: 8
cells: 4
...
# Work order: m-overlay-habits-habit-detail-drawer

## Goal

Bring `m-overlay-habits-habit-detail-drawer` to DESIGN.md. Read DESIGN.md once, then edit; the parts that apply to this surface are named below so you do not have to search for them.
...
- `apps/mobile/components/habits/description-viewer.tsx`
- `apps/mobile/components/habits/habit-calendar.tsx`
- `apps/mobile/components/habits/habit-detail-drawer.tsx`
- `apps/mobile/components/habits/habit-detail-drawer/habit-ask-astra-button.tsx`
- `apps/mobile/components/habits/habit-detail-drawer/habit-detail-header.tsx`
- `apps/mobile/components/habits/habit-detail-drawer/habit-detail-reminders.tsx`
- `apps/mobile/components/habits/habit-detail-drawer/styles.ts`
- `apps/mobile/components/habits/habit-detail-sections.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/mobile/components/habits/habit-calendar.tsx` | `local/spacing-scale` | 4 |
| `apps/mobile/components/habits/habit-detail-drawer/styles.ts` | `local/spacing-scale` | 4 |
| `apps/mobile/components/habits/description-viewer.tsx` | `local/spacing-scale` | 2 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'm-overlay-habits-habit-detail-drawer'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'm-overlay-habits-habit-detail-drawer'` agrees.
...
surface comes from `node tools/workorder.mjs --check --id 'm-overlay-habits-habit-detail-drawer'`, and it is a veto
