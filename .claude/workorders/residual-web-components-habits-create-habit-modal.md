---
surfaceId: residual-web-components-habits-create-habit-modal
platform: web
kind: residual
ownedFiles: 1
cells: 0
...
# Work order: residual-web-components-habits-create-habit-modal
...
- `apps/web/components/habits/create-habit-modal/sub-habit-editor.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/components/habits/create-habit-modal/sub-habit-editor.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-components-habits-create-habit-modal'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-components-habits-create-habit-modal'` agrees.
