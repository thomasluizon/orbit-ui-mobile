---
surfaceId: residual-web-app-(app)-social-challenges-_components
platform: web
kind: residual
ownedFiles: 2
cells: 0
...
# Work order: residual-web-app-(app)-social-challenges-_components
...
- `apps/web/app/(app)/social/challenges/_components/habit-picker.tsx`
- `apps/web/app/(app)/social/challenges/_components/share-join-code.tsx`
...
| file | rule | count |
|---|---|---|
| `apps/web/app/(app)/social/challenges/_components/share-join-code.tsx` | `local/spacing-scale` | 2 |
| `apps/web/app/(app)/social/challenges/_components/habit-picker.tsx` | `local/spacing-scale` | 1 |
...
1. Backlog A is 0 (`node tools/workorder.mjs --check --id 'residual-web-app-(app)-social-challenges-_components'` exits 0).
2. The diff touches only the owned files above: `tools/check-diff-ownership.mjs --id 'residual-web-app-(app)-social-challenges-_components'` agrees.
