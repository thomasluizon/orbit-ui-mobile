...
- **Memory**, save the decision + the durable facts to `the current project memory directory under ~/.claude/projects/` (check for an existing memory to update first), with a one-line pointer in `MEMORY.md`.
