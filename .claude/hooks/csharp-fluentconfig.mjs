...
// Forgetting the FluentConfig means EF infers schema — which is almost always wrong.
...
// New table = `migrationBuilder.CreateTable(name: "..."`.
...
for (const table of newTables) {
  // Singular entity name from table — strip trailing "s" as a coarse heuristic.
