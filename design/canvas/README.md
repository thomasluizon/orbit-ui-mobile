...
|---|---|---|
| 2026-09-10 | Light `--p-l-overdue` from `#946A00` to `#8C6400` | The old value missed the 4.5 text floor on the light well and hover surfaces. The new value measures 4.68 and 4.51 there, and 4.72 on the widget well, while preserving the OKLCH hue and its separation from the accent. |
