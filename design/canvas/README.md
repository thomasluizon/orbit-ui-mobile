...
|---|---|---|
| 2026-09-10 | Added dark `--track-empty` `#717174` and light `--track-empty` `#87878B`, then repointed `--status-empty` | The prior `--fg-4` binding missed the 3.0 non-text floor on raised surfaces. The dedicated track clears the worst surface in each mode and preserves the four-step neutral status ranking. |
