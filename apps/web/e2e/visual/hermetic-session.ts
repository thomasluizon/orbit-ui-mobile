...
/** Origin the built app is served on during the hermetic visual run. */
export const VISUAL_ORIGIN = 'http://127.0.0.1:3000'

/** Cookie/JWT expiry (seconds since epoch, year 2100) so the session never refreshes. */
export const HERMETIC_SESSION_EXPIRES = FAR_FUTURE_EXP_SECONDS
 ...
 */
export const FIXED_CLOCK_TIME = '2026-06-15T09:00:00.000Z'
 ...
 */
export function mintHermeticJwt(): string {
