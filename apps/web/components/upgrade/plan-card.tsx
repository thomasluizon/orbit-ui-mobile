...
export function PlanCard({ name, price, badge, selected = false, onClick }: Readonly<PlanCardProps>) {
  return (
    <button
      type="button"
      onClick={onClick}
      ...
      className="flex w-full items-center justify-between rounded-[20px] border-0 p-6 text-left"
      style={{
