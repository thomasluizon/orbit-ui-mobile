...
export function OnboardingCreateHabit(props: Readonly<OnboardingCreateHabitProps>) {
  ...
  const correctScheduleLabel = props.emoji
    ? `${t('when.correctSchedule')}. ${t('when.emojiLabel')}`
    : t('when.correctSchedule')
