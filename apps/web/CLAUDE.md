...
| Primitives (AppBar, SectionLabel, HabitRow, StatusDot, ParentRing, Chip, SettingsRow, InfoRow, PullQuote, ConfirmDialog, RingMotif) | `components/ui/*` + `components/habits/habit-row.tsx` + `components/chat/pull-quote.tsx` + `components/gamification/ring-motif.tsx` |
