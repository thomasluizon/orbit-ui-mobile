 ...
 * for an account that has not yet completed onboarding. On any 2xx the local draft is
 * cleared and the profile is marked onboarded; on failure the draft is retained for the next
 * mount and the error is reported.
 */
