/**
 * Orbit icon barrel (mobile). The ONE place app icons come from: Tabler icons wrapped
...
function makeIcon(Tabler: TablerIcon): ComponentType<IconProps> {
  return function Icon({ size = 22, strokeWidth = 1.8, ...rest }: IconProps) {
    return <Tabler size={size} strokeWidth={strokeWidth} {...rest} />
  }
}
