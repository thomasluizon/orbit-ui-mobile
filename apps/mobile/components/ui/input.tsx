...
function Control({ props, tokens }: Readonly<{ props: InputProps; tokens: Tokens }>) {
  ...
  return <View testID="input-control" style={[styles.control, { backgroundColor: tokens.bgField, borderColor: props.error ? tokens.statusBad : tokens.borderControl, borderWidth: props.error ? 2 : 1, outlineColor: tokens.primary, outlineOffset: 2, outlineWidth: focused && !props.disabled ? 2 : 0 }, props.disabled ? styles.disabled : null]}>
