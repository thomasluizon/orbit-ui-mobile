          ...
          >
            ...
            {habit.dueTime && (
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoText}>{displayTime(habit.dueTime)}</Text>
              </View>
            )}
              ...
              <View style={styles.infoRow}>
                ...
                <View style={styles.reminderChips}>
                  {habit.scheduledReminders.map((sr, idx) => (
                    <View key={`${sr.when}-${sr.time}-${idx}`} style={styles.reminderChip}>
            ...
            {metrics && !metricsLoading && (
              <View style={styles.statsGrid}>
                <View style={styles.statCard}>
                  ...
                  <Text style={styles.statLabel}>{t('habits.detail.currentStreak')}</Text>
                ...
                <View style={styles.statCard}>
                  ...
                  <Text style={styles.statLabel}>{t('habits.detail.longestStreak')}</Text>
                  <Text style={styles.statValue}>
                ...
                <View style={styles.statCard}>
                  ...
                  <Text style={styles.statLabel}>{t('habits.detail.monthlyRate')}</Text>
                  <Text style={styles.statValue}>
