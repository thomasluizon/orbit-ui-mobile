...
export function EditHabitModal({
  ...
  }, [habit, formHelpers, originalEndDate, selectedGoalIds, reminderTimes, tags, updateHabit, assignTags, onClose])
    ...
    >
      ...
      >
        ...
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity
            style={[styles.submitButton, updateHabit.isPending && styles.disabled]}
            disabled={updateHabit.isPending}
          ...
          >
            ...
            <Text style={styles.submitButtonText}>{t('habits.saveChanges')}</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </BottomSheetModal>
