...
export function CreateHabitModal({
  ...
  }, [formHelpers, isSubHabitMode, parentHabit, tags, selectedGoalIds, subHabits, reminderTimes, createHabit, createSubHabit, onClose])
          ...
          {!isSubHabitMode && (
            <View style={styles.subHabitsSection}>
                  ...
                  {subHabits.map((entry) => (
                    <View key={entry.id} style={styles.subHabitRow}>
                      <TextInput
                        ...
                        onChangeText={(val) => updateSubHabitValue(entry.id, val)}
                      />
                      <TouchableOpacity
              ...
              <TouchableOpacity
                ...
                onPress={() => setSubHabits((prev) => [...prev, createSubHabitEntry()])}
                activeOpacity={0.7}
              >
