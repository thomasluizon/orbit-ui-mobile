...
interface Props { createdHabit: string; emoji: string; remindersOff: boolean; skipped: boolean; signedOut: boolean; dueToday: boolean; onFinish: () => void }
export function OnboardingComplete({ createdHabit, emoji, remindersOff, skipped, signedOut, dueToday, onFinish }: Readonly<Props>) {
