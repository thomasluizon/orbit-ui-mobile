...
Skill behavior lives in each command's description; `/feature` and `/ticket` create executable
Linear tickets. `AGENTS.md` steers Codex review (D26); `guards.yml` supplies CI evidence and human
squash merge is mandatory (D25).
